...
$updateLastChecked = $pdo->prepare("UPDATE wp_media_renderer SET last_checked = NOW() WHERE license_key = ?");
...
$update = $pdo->prepare("UPDATE wp_media_renderer SET active = 1, domain = ?, last_checked = NOW() WHERE license_key = ?");
